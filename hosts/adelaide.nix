...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/4972b9d9-65de-4727-a269-af45aa5a4bc8";
      fsType = "btrfs";
      options = [ "defaults" "subvol=root" "compress=zstd" ];
    };
  fileSystems."/boot" = 
    { device = "/dev/disk/by-uuid/0E0B-A420";
      fsType = "vfat";
      options = [ "umask=077" "defaults" ];
      depends = ["/"];
    };
  fileSystems."/storage" = 
    { device = "/dev/disk/by-uuid/E9E4F5FDE9E4F5FD";
      fsType = "ntfs";
      options = [ "defaults" "uid=1000" "gid=1000" "dmask=007" "fmask=117" ];
      depends = ["/"];
    };
  ...
  fileSystems."/persist" =
    { device = "/dev/disk/by-uuid/4972b9d9-65de-4727-a269-af45aa5a4bc8";
      fsType = "btrfs";
      options = [ "defaults" "subvol=persist" "compress=zstd" ];
      depends = ["/"];
    };
